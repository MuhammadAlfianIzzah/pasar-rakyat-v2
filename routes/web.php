...
Route::prefix('setting')->middleware(["auth", IsAdmin::class])->group(function () {
    ...
    Route::middleware([IsSuperAdmin::class])->group(function () {
        ...
        Route::delete("/admin-kabupaten/{adminKabupaten:slug}", [AdminKabupatenController::class, "destroy"])->name("admin-kabupaten-destroy");
        Route::get("/admin-kabupaten/edit/{adminKabupaten:slug}", [AdminKabupatenController::class, "edit"])->name("admin-kabupaten-edit");
        Route::put("/admin-kabupaten/{adminKabupaten:slug}", [AdminKabupatenController::class, "update"])->name("admin-kabupaten-update");

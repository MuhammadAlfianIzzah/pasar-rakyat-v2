<x-admin-layout>
    ...
    <div class="row">
        <div class="col-6">
            <h4 class="text-dark">Daftar Vendor</h4>
        </div>
        <div class="col-6">
    ...
    <div class="row mt-4 mb-2 bg-white py-4 px-4">
        <form class="col-12" action="{{ route('daftar-vendor-store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('post')
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{ old('nama') }}" name="nama" class="form-control" id="nama">
                @error('nama')
                    <small class="form-text text-danger">{{ $message }}</small>
                @enderror
            </div>
            <div class="form-group">
                ...
                <input type="text" value="{{ old('nomor_hp') }}" name="nomor_hp" class="form-control" id="nomor_hp">
                @error('nomor_hp')
                    <small class="form-text text-danger">{{ $message }}</small>
                @enderror
            </div>
